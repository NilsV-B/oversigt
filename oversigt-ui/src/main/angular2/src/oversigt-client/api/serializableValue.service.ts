...
export class SerializableValueService {
    ...
    /**
     * Read JSONSchema for a serializable property
     *
     * @param type
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getJsonSchema(type: string, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public getJsonSchema(type: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public getJsonSchema(type: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public getJsonSchema(type: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<{ [key: string]: any; }>>(`${this.basePath}/serializable-values/schema/${encodeURIComponent(String(type))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
